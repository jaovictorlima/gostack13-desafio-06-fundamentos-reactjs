...
interface GetTransactionsWithBalance {
...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    api.get<GetTransactionsWithBalance>('/transactions').then(({ data }) => {
      const parsedValues = data.transactions.map(transaction => {
        return {
          ...transaction,
